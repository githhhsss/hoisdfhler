...
namespace YS_WEB.DAL
{
    ...
    /// 数据访问类:YS_User
    /// </summary>
    public partial class YS_UserDAL
    {
        public YS_UserDAL()
        { }
        #region  BasicMethod
        ...
        public bool Add(YS_WEB.Model.YS_User model)
        {
            ...
            strSql.Append("UserName,ReadName,Password,Address,Birthday,E_Mail,UserType,Question,Answer,HeadImg,Score,Company,CompanyType,CompanyGM,CompanyWebAdderss,MyMoney)");
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@Company", SqlDbType.NText),
        ...
        public YS_WEB.Model.YS_User GetModel()
        {
            ...
            return GetModel(strSql, parameters);
        }
        ...
        {
            string strSql = " where UserName=@UserName";
            SqlParameter[] parameters = {
                new SqlParameter("@UserName", SqlDbType.NVarChar,50)
			};
        ...
        {
            string strSql = " where UserName=@UserName and PassWord=@PassWord";
            SqlParameter[] parameters = {
                new SqlParameter("@UserName", SqlDbType.NVarChar,50),
                new SqlParameter("@Password", SqlDbType.NVarChar,50)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public YS_WEB.Model.YS_User GetModel(string where, SqlParameter[] parameters)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public YS_WEB.Model.YS_User DataRowToModel(DataRow row)
        {
            ...
            if (row != null)
            {
                ...
                {
                    model.UserType = (YS_WEB.Model.YS_Enum.UserType)int.Parse(row["UserType"].ToString());
                }
