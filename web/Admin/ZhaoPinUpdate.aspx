<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZhaoPinUpdate.aspx.cs" Inherits="User_Default" %>
        ...
        <div class="my-right">
            <div class="u-right">
                <div class="orderTitle">
                    <a href="ZhaoPinManager.aspx">招聘信息</a> <a href="ZhaoPinAdd.aspx">添加招聘</a> <a target="_blank"
                        href="ZhaoPinQuery.aspx">查看招聘</a> <a class="sel" href="ZhaoPinUpdate.aspx">修改招聘</a>
                </div>
                <!--信息-->
                <div class="data-edit">
                    ...
                    <div class="right-form">
                        <ul>
                            ...
                            <li><span class="form-title">公司：</span><input class="form-txt" id="ptxt1" type="text"
                                runat="server" /></li>
                            <li><span class="form-title">工作地区：</span><input class="form-txt" id="ptxt9" type="text"
                                runat="server" /></li>
                            <li><span class="form-title">职位：</span><input class="form-txt" id="ptxt2" type="text"
                                runat="server" /></li>
                            ...
                            <li><span class="form-title">联系电话：</span><input class="form-txt" id="ptxt4" runat="server"
                                type="text" /></li>
                            <li><span class="form-title">公司地址：</span><input class="form-txt" id="ptxt3" runat="server"
                                type="text" /></li>
