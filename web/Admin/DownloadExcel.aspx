<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DownloadExcel.aspx.cs" Inherits="Admin_DownloadExcel" %>
        ...
        <div class="my-right">
            <div class="u-right">
                <div class="orderTitle">
                    <a href="UploadExcel.aspx">上传资料</a> <a class="sel" href="DownloadExcel.aspx">下载资料</a>
                ...
                <div class="data-edit">
                    ...
                    <div class="right-form">
                        <ul>
                            <li>
                                <asp:LinkButton ID="ChangeMyInformation" class="btn" runat="server" OnClick="ChangeMyInformation_Click">确认下载</asp:LinkButton></li>
                        </ul>
                    </div>
                    </form>
                </div>
