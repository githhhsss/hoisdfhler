        ...
        <div class="my-right">
            <div class="u-right">
                <div class="orderTitle">
                    <a href="UserManager.aspx">用户列表</a> <a class="sel" href="UserAdd.aspx">新增用户</a>
                </div>
                <!--信息-->
                <div class="data-edit">
                    ...
                    <div class="right-form">
                        <ul>
                            ...
                            <li><span class="form-title">用户名：</span><input class="form-txt" id="mynametxt" type="text"
                                runat="server" /></li>
                            <li><span class="form-title">真实姓名：</span><input class="form-txt" id="myreadnametxt"
                                runat="server" type="text" /></li>
                            <li><span class="form-title">地址：</span><input class="form-txt" id="myaddresstxt"
                                runat="server" type="text" /></li>
                            <li><span class="form-title">e-mail：</span><input class="form-txt" id="myemailtxt"
                                runat="server" type="text" /></li>
                            ...
                            <li><span class="form-title">公司简介：</span><textarea class="form-mtxt" id="mycjjtxt"
                                cols="20" rows="2"></textarea></li>
                            <li><span class="form-title">公司类型：</span><input class="form-txt" id="myclxtxt" runat="server"
                                type="text" /></li>
                            ...
                            <li><span class="form-title">公司网站：</span><input class="form-txt" id="mycwztxt" runat="server"
                                type="text" /></li>
