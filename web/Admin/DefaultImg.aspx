        ...
        <div class="my-right">
            <div class="u-right">
                <div class="orderTitle">
                    <a href="Default.aspx">个人信息</a> <a href="DefaultPasswrod.aspx">修改密码</a> <a class="sel"
                        href="DefaultImg.aspx">更改头像</a>
                </div>
                <!--信息-->
                <div class="data-edit">
                    ...
                    <div style="margin-top: 80px; margin-left: 100px;">
                        <ul>
                            <li><span style="font-family: Tahoma, Helvetica, Arial, 宋体, sans-serif; line-height: 35px;
                                font-size: 14px; color: #999; font-weight: bold;">当前图像</span></li>
                            <li>
                                <div style="float: left; width: 303px; height: 303px; border: solid 1px #e1e1e1;
                                    padding: 3px;">
                                    <img src="/User/UserPic/u_face.jpg" width="300" height="300" runat="server" id="userImg"
                                        style="border: solid 1px #fafafa;" />
                                </div>
                                <div style="float: left; width: 330px; margin-left: 30px; margin-top: 20px;">
                                    <img src="../Images/user/headImg.jpg" /></div>
                                <div class="clear">
                                </div>
                            </li>
                            <li><span style="font-family: Tahoma, Helvetica, Arial, 宋体, sans-serif; line-height: 35px;
                                font-size: 14px; color: #999; font-weight: bold;">更换头像</span></li>
                            <li>
                                <asp:FileUpload ID="FileUpload1" runat="server" Style="width: 350px; height: 25px;" />
                                <asp:Button ID="Button1" Style="width: 50px; height: 25px;" runat="server" Text="上 传"
                                    OnClick="Button1_Click" /><asp:HiddenField ID="HiddenField1" runat="server" Value="false" />
                                <asp:HiddenField ID="HiddenField2" runat="server" Value="false" />
                            </li>
                            <li><span style="font-family: Tahoma, Helvetica, Arial, 宋体, sans-serif; line-height: 25px;
                                font-size: 12px; color: #f60">请不要上传反动，色情，暴力等违法的图片。</span></li>
                            <li><span style="font-family: Tahoma, Helvetica, Arial, 宋体, sans-serif; line-height: 25px;
                                font-size: 12px; color: #969696">支持jpg,jpeg,png,gif格式的图片,文件大小不能超过200K</span></li>
                        </ul>
                    </div>
                    </form>
                </div>
