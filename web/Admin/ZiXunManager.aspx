                    ...
                    <div class="right-form">
                        <ul>
                            <li><span class="u-th-1">序号</span> <span class="u-th-2">标题</span> <span class="u-th-3">
                                关键字</span> <span class="u-th-7">录入时间</span> <span class="u-th-do">操作</span>
                            </li>
                                    ...
                                    <li><span class="u-td-1 <%# (Container.ItemIndex % 2 == 0) ? "odd" : "edd" %>">
                                        <%# Container.ItemIndex+1 %></span> <span class="u-td-2 <%# (Container.ItemIndex % 2 == 0) ? "odd" : "edd" %>">
                                            <%# Eval("ProductName")%></span> <span class="u-td-3 <%# (Container.ItemIndex % 2 == 0) ? "odd" : "edd" %>">
                                                <%# Eval("ProductKey")%></span> <span class="u-td-7 <%# (Container.ItemIndex % 2 == 0) ? "odd" : "edd" %>">
                                                    <%# Convert.ToDateTime(Eval("InputTime")).ToString("yyyy-MM-dd hh:mm")%></span>
                                        <span class="u-td-do <%# (Container.ItemIndex % 2 == 0) ? "odd" : "edd" %>"><a href="ZiXunUpdate.aspx?itemid=<%# Eval("ID")%>">
                                            查看</a> <a href="ZiXunUpdate.aspx?itemid=<%# Eval("ID")%>">编辑</a> <a href="javascript:;"
