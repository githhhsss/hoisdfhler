        ...
        <div class="my-right">
            <div class="u-right">
                <div class="orderTitle">
                    <a href="ZiXunManager.aspx">资讯文章</a> <a href="ZiXunAdd.aspx">添加资讯</a> <a target="_blank"
                        href="ZiXunQuery.aspx">查看资讯</a> <a class="sel" href="ZiXunUpdate.aspx">修改资讯</a>
                </div>
                <!--信息-->
                <div class="data-edit">
                    ...
                    <div class="right-form">
                        <ul>
                            ...
                            <li><span class="form-title">资讯类别:</span><asp:DropDownList ID="content" runat="server"
                                AutoPostBack="True">
                            ...
                            <li><span class="form-title">标题：</span><input class="form-txt" id="ptxt1" type="text"
                                runat="server" /></li>
                            <li><span class="form-title">关键字：</span><input class="form-txt" id="ptxt4" type="text"
                                runat="server" /></li>
                            ...
                            <li>
                                <asp:LinkButton ID="AddPro" class="btn" runat="server" OnClick="AddPro_Click" OnClientClick="tj_click()">确认添加</asp:LinkButton></li>
                        </ul>
