<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DefaultPasswrod.aspx.cs" Inherits="User_Default" %>
...
<head id="Head1" runat="server">
    ...
    .right-form{ margin-top:80px; margin-left:100px;}
    .right-form ul li .form-title{ display:inline-block;width:120px; height:40px; color:#123654; line-height:40px; text-align:right; font-size:18px; margin-bottom:10px;}
    .right-form ul li .form-txt{height:40px;line-height:40px; font-size:18px; width:500px; }
    
    .right-form ul li .btn{ display:block ;background:url("../Images/btnbj.png") no-repeat center center; width:150px; height:40px;background-size:cover; font-size:18px; text-align:center; line-height:40px; margin-left:472px;}
    ...
    <div class="web-page">
        <div class="my-left">
            <div class="my-left-top">
                <ul>
                    <li><img class="headimg" id="headImg" src="/User/UserPic/u_face.jpg" runat="server" /></li>
                    <li>
                        <div class="myName">
        ...
        <div class="my-right">
            ...
            <div class="orderTitle">
                ...
                <a class="sel" href="DefaultPasswrod.aspx">修改密码</a> 
            ...
            <div class="data-edit">
                ...
                <div class="right-form">
                    <ul>
                        <li><span class="form-title">原密码：</span><input class="form-txt" id="passwordtxt1" type="password" /></li>
                        <li><span class="form-title">新密码：</span><input class="form-txt" id="passwordtxt2" type="password" /></li>
                        <li><span class="form-title">确认密码：</span><input class="form-txt" id="passwordtxt3" type="password" /></li>
                        <li><a id="ChangePassword" class="btn" href="javascript:;">确认修改</a></li>
                    </ul>
                </div>
                </form>
            </div>
    ...
    <script type="text/javascript">
        $(function () {
            $("#ChangePassword").click(function () {
                yscom.ajax({
                    url: "Action/Handler.ashx?cmd=ChangePassword",
                    data: {
                        "password1": $("#passwordtxt1").val(),
                        "password2": $("#passwordtxt2").val(),
                        "password3": $("#passwordtxt3").val()
                    },
