...
<body>
    ...
    <div class="equipment-body">
            ...
            <div class="equipment-body-list">联系人&nbsp;：<input id="RegisterText5" type="text" /></div>
            <div class="equipment-body-list">联系电话：<input id="RegisterText6" type="text" /></div>
        </div>
         <div class="equipment-textarea"><span style="float:left">详细描述：</span><textarea id="RegisterText7" cols="45" rows="15"></textarea></div>
