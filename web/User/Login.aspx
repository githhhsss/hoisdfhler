    ...
    <div class="web-page">
        <div class="web-login">
            ...
            <div class="login-button">
                ...
                <a href="Register.aspx" class="zc"  onmouseover="this.style.backgroundImage='url(../images/login/ZC_h.png)'" onmouseout="this.style.backgroundImage='url(../images/login/ZC.png)'"></a>
            </div>
        </div>
    </div>
