<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Orders.aspx.cs" Inherits="Order_Orders" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .Recruitment-imgtitle
        {
            width: 100%;
            height: 515px;
            background: url('/images/Recruitment/title.png') center bottom no-repeat;
        }
        .Recruitment-wordtitle
        {
            width: 100%;
            height: 39px;
            margin-top: 38px;
        ...
        .Recruitment-img1 img
        {
            src: url('/images/Recruitment/x.png');
            height: 14px;
            width: 194px;
        }
        .Recruitment-SO
        ...
        .Recruitment-SO ul li
        {
            list-style: none;
            float: left;
            padding: 0px;
        }
        .Recruitment-SO-ul-li1
        {
            font-size: 16px;
            font-weight: bold;
            margin-right: 50px;
        ...
        .Recruitment-SO-ul-input
        {
            ...
            color: #bbbbc0;
            font-weight: bold;
            background: url('/images/zpjd/ss.png') center bottom no-repeat;
        }
        ...
        .Recruitment-city .Recruitment-city-ul-li1
        {
            margin-right: 100px;
        }
        .Recruitment-line
...
<body>
    ...
    <div class="web-page">
        <div class="Recruitment-imgtitle">
        </div>
        <div class="Recruitment-wordtitle">
            我要接单</div>
        <div class="Recruitment-img1">
            <img src="/images/Recruitment/x.png" /></div>
                ...
                <a href='Orders_Detail.aspx?pid=<%# Eval("ID") %>'>
                    <div class="Recruitment-title">
                        <ul>
                            ...
                            <li class="Recruitment-title-city">（<%# Eval("ProductAddress")%>）</li>
                            <li class="Recruitment-title-Salary">日薪<%# Convert.ToDecimal( Eval("Price")).ToString("f2")%></li>
                        </ul>
                    </div>
