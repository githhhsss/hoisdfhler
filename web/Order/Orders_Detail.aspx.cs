...
public partial class Order_Orders_Detail : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.zptxt5.InnerHtml = p.StartTime.ToString("yyyy-MM-dd HH:mm"); ;
        
        this.zptxt6.InnerHtml = p.ProductAddress;
