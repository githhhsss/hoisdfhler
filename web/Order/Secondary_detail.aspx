...
<head runat="server">
    ...
    .Secondary_detail-whitebox{ background-color:White; width:1196px; position:absolute;top:91px;left:85px; height:910px;}
...
<body>
    ...
    <div class="Secondary_detail-name">Iphone6（9成新）</div>
    <div class="Secondary_detail-name-detailed">
    <ul>
    <li><span class="Secondary_detail-name-detailed-leftspan">价&nbsp;格：</span><span class="Secondary_detail-name-detailed-rightspan">￥1200</span></li>
     <li><span class="Secondary_detail-name-detailed-leftspan">成&nbsp;色：</span><span class="Secondary_detail-name-detailed-rightspan">9成新</span></li>
      <li><span class="Secondary_detail-name-detailed-leftspan">区&nbsp;域：</span><span class="Secondary_detail-name-detailed-rightspan">广州</span></li>
    <li><span class="Secondary_detail-name-detailed-leftspan">联系人：</span><span class="Secondary_detail-name-detailed-rightspan">屎生</span></li>
    <li><span class="Secondary_detail-name-detailed-leftspan">电&nbsp;话：</span><span class="Secondary_detail-name-detailed-rightspan">1380013800</span></li>
    </ul>
    </div>
    </div>
    <div class="Secondary_detail-xq">商品详情</div>
    <div class="Secondary_detail-line"><hr /></div>
    <div class="Secondary_detail-context"></div>
    </div>
    </div>
