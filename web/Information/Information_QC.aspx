<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Information_QC.aspx.cs" Inherits="Information_Information_QC" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        .Photography-imgtype
        {
            background: url('/images/Information/QC_title.png') center bottom no-repeat;
            width: 727px;
            height: 65px;
            margin-left: 320px;
            margin-top: 60px;
