<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Information_DYDSJ.aspx.cs" Inherits="Information_Information_DYDSJ" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        .Photography-imgtype
        {
            background: url('/images/Information/dydsj_title.png') center bottom no-repeat;
            width: 727px;
            height: 65px;
            margin-left: 320px;
            margin-top: 60px;
            ...
            if (isadd == true) {
                if ($(window).scrollTop() + 500 >= $(document).height() - $(window).height()) {
                    ...
                    $.ajax({
                        type: "POST",
                        dataType: "json",
                        url: "Action/Handler.ashx?cmd=GetProducts4",
                        data: { "sItem": sItem },
